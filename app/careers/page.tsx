  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-blue-900 dark:to-blue-800">
      ...
      <main className="container mx-auto px-4 py-16">
        <h1 className="text-4xl mb-8 text-center bg-clip-text text-black">채용 정보</h1>
        
        <div className="max-w-3xl mx-auto my-16">
          <h2 className="text-2xl mb-4 text-center">무브과 함께 성장하세요</h2>
        ...
        <h2 className="text-3xl my-8 text-center">현재 채용 중인 포지션</h2>
        ...
        <div className="mb-16">
          <h2 className="text-3xl mb-8 text-center">무브에서 일하는 이유</h2>
        ...
        {/* <div className="text-center">
          <h2 className="text-3xl font-bold mb-4"> 미래를 만들어갈 준비가 되셨나요?</h2>
