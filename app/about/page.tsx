...
export default function AboutPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="max-w-full mx-auto mb-16">
          <div className="text-center mb-16 mx-auto">
            <p className="text-3xl text-center font-bold max-w-3xl mx-auto">
              &quot;모두를 위한 스마트한 쇼핑&quot;</p>
              <p className="text-lg mt-6">우리는 기술과 서비스의 혁신을 통해 모든 고객에게 편리하고 즐거운 쇼핑 경험을 제공합니다.</p>
          </div>
        <div>
    ...
    <div className="max-w-3xl mx-auto mt-6 text-center">
      <p className="text-lg leading-relaxed my-6 mt-16">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        <Badge className="text-sm px-3 py-1 border-primary bg-white">고객 중심 서비스</Badge>
        <Badge className="text-sm px-3 py-1 border-primary bg-white">품질 보증 제품</Badge>
        <Badge className="text-sm px-3 py-1 border-primary bg-white">빠른 안전 배송</Badge>
        <Badge className="text-sm px-3 py-1 border-primary bg-white">24/7 고객 지원</Badge>
      </div>
    </div>
    </main>
      <div className="container-fluid">
        <div className="text-center py-20 mt-16"  style={{
