  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-blue-900 dark:to-blue-800">
      ...
      <main className="container mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400">무브 소개</h1>
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-4">함께 성장하는 무브</h2>
